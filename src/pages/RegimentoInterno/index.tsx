        ...
        <main className="min-h-screen bg-slate-50 pt-20">
            ...
            <section className="max-w-5xl mx-auto px-4 py-16 space-y-8">
                <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 space-y-4">
                    <div className="flex items-center gap-3 text-blue-700 font-black text-sm uppercase tracking-widest">
                        <ShieldCheck size={18} />
                ...
                <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 grid md:grid-cols-3 gap-6">
                    {[
                        ...
                        <div key={item} className="flex items-start gap-3">
                            <CheckCircle2 className="text-blue-700 mt-1" size={18} />
