        ...
        <main className="pt-20 bg-slate-50 min-h-screen">
            ...
            <section className="bg-linear-to-r from-blue-900 via-blue-800 to-blue-700 text-white py-16">
                <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-2 gap-10 items-center">
                    ...
                    <div className="bg-white text-slate-900 rounded-2xl shadow-xl p-8 space-y-6 border border-white/30">
                        <h3 className="text-2xl font-bold text-slate-900">Nosso compromisso</h3>
                        <div className="grid sm:grid-cols-2 gap-4">
                            <div className="p-4 bg-slate-50 rounded-xl border border-slate-100">
                                <Target className="w-6 h-6 text-blue-700" />
                                <p className="mt-3 text-sm text-slate-600">Objetivo claro: desenvolvimento integral de cada criança.</p>
                            </div>
                            <div className="p-4 bg-slate-50 rounded-xl border border-slate-100">
                                <BookOpen className="w-6 h-6 text-blue-700" />
                                <p className="mt-3 text-sm text-slate-600">Propostas pedagógicas alinhadas à BNCC e valores humanos.</p>
                            </div>
                            <div className="p-4 bg-slate-50 rounded-xl border border-slate-100">
                                <Users2 className="w-6 h-6 text-blue-700" />
                                <p className="mt-3 text-sm text-slate-600">Família e comunidade como parceiras permanentes.</p>
                            </div>
                            <div className="p-4 bg-slate-50 rounded-xl border border-slate-100">
                                <HeartHandshake className="w-6 h-6 text-blue-700" />
                                <p className="mt-3 text-sm text-slate-600">Ética, respeito e afeto em todas as relações.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="max-w-7xl mx-auto px-4">
                    <div className="grid md:grid-cols-3 gap-6">
                        <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
                            <div className="inline-flex items-center justify-center p-3 rounded-xl bg-blue-50 text-blue-700 mb-4">
                                <Target size={22} />
                            </div>
                            <h3 className="text-xl font-bold text-slate-900 mb-3">Missão</h3>
                            <p className="text-slate-600">Preparar hoje, cidadãos para o futuro.</p>
                        </div>
                        <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
                            <div className="inline-flex items-center justify-center p-3 rounded-xl bg-blue-50 text-blue-700 mb-4">
                                <Lightbulb size={22} />
                            ...
                            <p className="text-slate-600">Proporcionar bem-estar a cada criança/adolescente e suas famílias, com proteção social, espaço seguro e relações de afetividade.</p>
                        </div>
                        <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
                            <div className="inline-flex items-center justify-center p-3 rounded-xl bg-blue-50 text-blue-700 mb-4">
                            ...
                            <p className="text-slate-600">Empatia, ética, excelência pedagógica, corresponsabilidade e celebração das conquistas de cada criança.</p>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-7xl mx-auto px-4 space-y-10">
                    <div className="bg-white border border-slate-100 rounded-3xl shadow-sm p-8 md:p-10">
                        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
                            <div>
                                <h2 className="text-2xl font-bold text-slate-900 mb-3">Quem somos</h2>
                                <p className="text-slate-600">Entidade sem fins lucrativos com sede na Rua José Pereira, 780, Vila Bazani, Itapira-SP, atendendo crianças e adolescentes de 0 a 14 anos.</p>
                                <p className="text-slate-600 mt-3">Fundado em 25 de janeiro de 1959 pelo Padre Mateus Ruiz Domingues, o Educandário nasceu da compaixão e do desejo de oferecer um futuro digno às crianças de Itapira. Hoje, aos 67 anos, mantemos vivo o legado de acolhimento, atendendo cerca de 260 crianças e adolescentes diariamente.</p>
                            </div>
                        ...
                        <div className="grid md:grid-cols-3 gap-6">
                            <div className="p-5 bg-slate-50 rounded-2xl border border-slate-100">
                                ...
                                <p className="mt-2 text-sm font-semibold text-slate-800">Horário de funcionamento</p>
                                <p className="text-sm text-slate-600">07h às 17h</p>
                            </div>
                            <div className="p-5 bg-slate-50 rounded-2xl border border-slate-100">
                                <Users2 className="w-5 h-5 text-blue-700" />
                                <p className="mt-2 text-sm font-semibold text-slate-800">Equipe multidisciplinar</p>
                                <p className="text-sm text-slate-600">Psicólogas, coordenação pedagógica, assistentes sociais, nutricionista, educadores, administração e cozinha.</p>
                            </div>
                            <div className="p-5 bg-slate-50 rounded-2xl border border-slate-100">
                                <MapPin className="w-5 h-5 text-blue-700" />
                                <p className="mt-2 text-sm font-semibold text-slate-800">Localização</p>
                                <p className="text-sm text-slate-600">Rua José Pereira, 780 – Vila Bazani – Itapira/SP</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-6">
                        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
                            <h3 className="text-xl font-bold text-slate-900 mb-4">Diretoria voluntária</h3>
                        ...
                        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
                            <h3 className="text-xl font-bold text-slate-900 mb-4">Conselheiros</h3>
                            <ul className="space-y-2 text-slate-700 text-sm">
                    ...
                    <div className="grid lg:grid-cols-2 gap-6">
                        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
                            <h3 className="text-xl font-bold text-slate-900 mb-3">Nossas atividades</h3>
                            <p className="text-slate-600 text-sm mb-4">Programas que integram cuidado, educação e desenvolvimento socioemocional.</p>
                            <ul className="space-y-2 text-slate-700 text-sm">
                                {activities.map((item) => (
                        ...
                        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
                            <h3 className="text-xl font-bold text-slate-900 mb-3">Fontes de renda</h3>
                            <p className="text-slate-600 text-sm mb-4">Sustentamos nossas ações com uma combinação de apoio público e comunitário.</p>
                            <ul className="space-y-2 text-slate-700 text-sm">
                                {income.map((item) => (
                                    <li key={item} className="flex items-start gap-2">
                                        <HandCoins className="w-4 h-4 text-blue-700 mt-0.5" />
                                        <span>{item}</span>
                                    </li>
                                ))}
                            </ul>
                    ...
                    <div className="bg-white rounded-3xl shadow-sm border border-slate-100 p-8 md:p-10">
                        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-8">
                            <div>
                                <h2 className="text-2xl font-bold text-slate-900">Impacto em números</h2>
                                <p className="text-slate-600">Indicadores que mostram nossa trajetória e dedicação diária.</p>
                            </div>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                            {highlights.map((item) => (
                                <div key={item.label} className="p-5 rounded-2xl bg-slate-50 border border-slate-100 text-center">
                                    <div className="text-3xl font-black text-blue-800">{item.value}</div>
            ...
            <section className="pb-20">
                <div className="max-w-7xl mx-auto px-4">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
                        <div>
                            <h2 className="text-2xl font-bold text-slate-900">Nossos pilares na prática</h2>
                            <p className="text-slate-600">Como vivenciamos nossos valores no dia a dia do Educandário.</p>
                        </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                        {values.map((value) => (
                            <div key={value.title} className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm flex gap-4">
                                <div className="p-3 bg-slate-50 rounded-xl text-blue-700">
                                    {value.icon}
                                </div>
                                <div>
                                    <h3 className="text-lg font-semibold text-slate-900">{value.title}</h3>
                                    <p className="text-slate-600 text-sm mt-2">{value.description}</p>
                                </div>
                            </div>
                        ))}
                    </div>
            ...
            <section className="pb-16">
                <div className="max-w-7xl mx-auto px-4">
                    <div className="bg-white rounded-3xl shadow-sm border border-slate-100 p-8 md:p-10">
                        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
                            <div>
                                <h2 className="text-2xl font-bold text-slate-900">Localização e contato</h2>
                                <p className="text-slate-600">Estamos prontos para acolher e responder a dúvidas.</p>
                            </div>
                            <div className="inline-flex items-center gap-2 text-sm text-blue-700 bg-blue-50 px-3 py-1 rounded-full border border-blue-100">
